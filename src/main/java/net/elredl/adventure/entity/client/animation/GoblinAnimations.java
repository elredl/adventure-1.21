package net.elredl.adventure.entity.client.animation;
...
public class GoblinAnimations {
    ...
    public static final Animation idle = Animation.Builder.create(1.0F)
            .addBoneAnimation("Head", new Transformation(Transformation.Targets.ROTATE,
                    new Keyframe(0.0F, AnimationHelper.createRotationalVector(0.0F, 0.0F, 0.0F), Transformation.Interpolations.LINEAR),
                    new Keyframe(0.0833F, AnimationHelper.createRotationalVector(-2.6602F, 19.9802F, -0.9096F), Transformation.Interpolations.LINEAR),
                    new Keyframe(0.4167F, AnimationHelper.createRotationalVector(-2.6602F, 19.9802F, -0.9096F), Transformation.Interpolations.LINEAR),
                    new Keyframe(0.5F, AnimationHelper.createRotationalVector(-1.1581F, -24.5022F, 0.2645F), Transformation.Interpolations.LINEAR),
                    new Keyframe(0.875F, AnimationHelper.createRotationalVector(-1.1581F, -24.5022F, 0.2645F), Transformation.Interpolations.LINEAR),
