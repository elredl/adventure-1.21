package net.elredl.adventure.entity.custom;
...
public class GoblinEntity extends AnimalEntity {
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(3, new TemptGoal(this, 1.25, stack -> stack.isOf(ModItems.GOBLIN_SLOP), false));
    ...
    public boolean isBreedingItem(ItemStack stack) {
        return stack.isOf(ModItems.GOBLIN_SLOP);
    }
